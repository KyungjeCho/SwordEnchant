...
{
    public class FireBoltProjectileManager : BaseProjectileManager
    {
        ...
        protected override void OnEnable()
        {
            ...
            {
                weaponObject = Resources.Load("WeaponSystem/FireBolt") as WeaponObject;
            }
        }
        ...
        IEnumerator WaitForShot()
        {
            ...
            FireBoltController controller = poolable.GetComponent<FireBoltController>();
