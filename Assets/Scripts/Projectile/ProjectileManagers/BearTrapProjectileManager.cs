...
{
    public class BearTrapProjectileManager : BaseProjectileManager
    {
        ...
        protected override void OnEnable()
        {
            ...
            {
                weaponObject = Resources.Load("WeaponSystem/BearTrap") as WeaponObject;
            }
        }
        ...
        IEnumerator WaitForShot()
        {
            ...
            BearTrapController controller = poolable.GetComponent<BearTrapController>();
